...
[_QWERTY] = {
  ...
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V, F(EV_B),    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    F(EV_H)},
...
[_DIGITS] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    KC_ASTR, KC_EQL },
  {_______, _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_MINS, KC_PLUS},
...
[_SYMBOLS] = {
  ...
  {_______, _______, _______, _______, _______, _______, KC_GRV,  KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS, KC_EQL },
  {_______, _______, _______, _______, _______, _______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_MINS, KC_PLUS},
  {_______, _______, _______, _______, _______, _______, _______, KC_RPRN, _______, _______, KC_PIPE, KC_BSLS}
},
 ...
 */
[_BRACES] = {
  {_______, _______, _______, _______, _______, _______, KC_TILD, KC_LABK, KC_RABK, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, KC_GRV,  KC_LCBR, KC_RCBR, _______, KC_UNDS, KC_EQL },
  {_______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, KC_MINS, KC_PLUS},
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [EV_H]  =  ACTION_MODS_TAP_KEY(MOD_RSFT, KC_ENT )   //
};
